export EDITOR='/Users/akhkharu/bin/subl'
export GIT_EDITOR='/Users/akhkharu/bin/subl -w'
...
export PATH="$PATH:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools:$ANDROID_NDK_HOME:/usr/local/sbin:$EC2_HOME/bin:$AWS_ELB_HOME/bin"
